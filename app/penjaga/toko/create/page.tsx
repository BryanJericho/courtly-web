...
import { createToko } from "../../../lib/firestore";
        ...
        <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Daftar Toko Baru</h1>
              <p className="mt-2 text-gray-600">
                Lengkapi informasi toko olahraga Anda
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800">
                    ℹ️ Toko Anda akan menunggu persetujuan dari admin sebelum dapat digunakan.
                  </p>
                </div>
